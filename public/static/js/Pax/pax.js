define(["jquery", "jqueryBase64"], function ($) {
  ...
  var PAX = {
    ...
    GetSignature: function (getSignatureInfo, callback) {
      ...
      var requestlength_hex = base64ToHex(
        $.base64.btoa(getSignatureInfo.requestlength)
      );
    ...
    DoSignature: function (doSignatureInfo, callback) {
      ...
      var uploadFlag_hex = base64ToHex(
        $.base64.btoa(doSignatureInfo.uploadFlag)
      );
      var hostReferenceNumber_hex = base64ToHex(
        $.base64.btoa(doSignatureInfo.hostReferenceNumber)
      );
